define({ "api": [
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "subtype",
            "description": "<p>Version subtype (<strong>required</strong> only for versions with type <code>2 - tablet</code> or <code>3 - mobile</code>)</p>"
          },
          {
            "group": "Parameter",
            "type": "Boolean",
            "optional": true,
            "field": "autoScale",
            "description": "<p>Auto fit scale flag for mobile and tablet Version types (<code>false</code> by default)</p>"
          },
          {
            "group": "Parameter",
            "type": "Boolean",
            "optional": true,
            "field": "retinaScale",
            "description": "<p>Retina scale flag for desktop Version types (<code>false</code> by default)</p>"
          }
        ]
      }
    },
  ...
  },
  {
    "type": "PUT",
    "url": "/versions/:id",
    "title": "02. Update version",
    "name": "update",
    "group": "Versions",
    "description": "<p>Update and return an existing <code>Version</code> model owned by the authenticated user.</p>",
    "permission": [
      {
        "name": "User",
        "title": "User access only",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "autoScale",
            "description": "<p>fit    Auto scale flag for mobile and tablet Version types (<code>false</code> by default)</p>"
          },
          {
            "group": "Parameter",
            "type": "Boolean",
  ...
  },
  {
    ...
    "name": "view",
    "group": "Versions",
    "description": "<p>Return an existing <code>Version</code> model owned by the authenticated user.</p>",
    "permission": [
      {
        "name": "User",
        "title": "User access only",
