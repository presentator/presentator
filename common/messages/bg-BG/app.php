...
return array(
    ...
    'Are you really sure you want to delete user {userEmail}?' => 'Наистина ли искаш да изтриеш потребител {userEmail}?',
    ...
    'Choose screen transition...' => 'Избери анимация...',
    ...
    'Dashboard' => 'Табло',
    'Date' => 'Дата',
    'Date Modified' => 'Последна промяна',
    'Delete' => 'Изтрий',
    ...
    'Regular user' => 'Стандартен потребител',
    ...
    'Share' => 'Сподели',
    'Sharing' => 'Споделяне',
    'Show only my projects' => 'Покажи само моите проекти',
    ...
    'Successfully created a new user.' => 'Успешно бе добавен нов потребител.',
    ...
    'Successfully updated user.' => 'Потребителят бе обновен успешно.',
    ...
    'The user was successfully deleted.' => 'Потребителят бе премахнат успешно',
