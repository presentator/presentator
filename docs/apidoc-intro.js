...
_The API is still in very early development and therefore if you have any feature suggestions, please report them at the [project GitHub issues page](https://github.com/ganigeorgiev/presentator/issues)._
 */

/**
 * @api {hide} off
 * 01. Localizing response
 * @apiName localizations
 * @apiGroup Intro
 * @apiSampleRequest off
 * @apiDescription
Each API response could be localized with the `lang` GET parameter:
```
?lang=bg
```
Currently available language codes are: `bg`, `en`, `pt-br`, `pl`.
...
/**
 * @api {hide} off
 * 03. "fields" and "expand" parameters
