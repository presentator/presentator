 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function p(e){var t={},r={},n={},o={__esModule:!0,initializeApp:f,app:c,apps:null,SDK_VERSION:h,INTERNAL:{registerService:p,removeApp:a,factories:r,useAsService:v}};function a(e){var r=t[e];d(r,"delete"),delete t[e]}function c(e){if(e=e||u,!i.contains(t,e))throw s.create("no-app",{appName:e});return t[e]}function f(r,n){if(void 0===n&&(n={}),"object"!==typeof n||null===n){var a=n;n={name:a}}var c=n;void 0===c.name&&(c.name=u);var f=c.name;if("string"!==typeof f||!f)throw s.create("bad-app-name",{appName:String(f)});if(i.contains(t,f))throw s.create("duplicate-app",{appName:f});var l=new e(r,c,o);return t[f]=l,d(l,"create"),l}function l(){return Object.keys(t).map(function(e){return t[e]})}function p(t,a,u,f,h){if(void 0===h&&(h=!1),r[t])throw s.create("duplicate-service",{appName:t});function p(e){if(void 0===e&&(e=c()),"function"!==typeof e[t])throw s.create("invalid-app-argument",{appName:t});return e[t]()}return r[t]=a,f&&(n[t]=f,l().forEach(function(e){f("create",e)})),void 0!==u&&i.deepExtend(p,u),o[t]=p,e.prototype[t]=function(){for(var e=[],r=0;r<arguments.length;r++)e[r]=arguments[r];var n=this._getService.bind(this,t);return n.apply(this,h?e:[])},p}function d(e,t){for(var o=0,i=Object.keys(r);o<i.length;o++){var a=i[o],c=v(e,a);if(null===c)return;n[c]&&n[c](t,e)}}function v(e,t){if("serverAuth"===t)return null;var r=t;return r}return o["default"]=o,Object.defineProperty(o,"apps",{get:l}),c["App"]=e,o}
/**
 * @license
 * Copyright 2019 Google Inc.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function d(){var e=p(l);function t(t){i.deepExtend(e,t)}return e.INTERNAL=o.__assign({},e.INTERNAL,{createFirebaseNamespace:d,extendNamespace:t,createSubscribe:i.createSubscribe,ErrorFactory:i.ErrorFactory,deepExtend:i.deepExtend}),e}
/**
 * @license
 * Copyright 2017 Google Inc.
 *
